...
import { useGetSingleUser } from '@services/user/get'
...
const UserView = () => {
  ...
  const { data: userData } = useGetSingleUser(id as string)
            ...
            <CardContent sx={{ pb: 4 }}>
              ...
              <Grid container spacing={6} sx={{ pt: 4 }}>
                <Grid item xl={6}>
                  ...
                  >
                    <Typography sx={{ mr: 2, fontWeight: 500, color: 'text.secondary', fontSize: '20px' }}>
                      Email
                    </Typography>
                    <Typography sx={{ color: 'text.secondary', fontSize: '25px' }}>{userData.email}</Typography>
                  </Card>
                </Grid>
